...
import { NATIVE, ZERO, Token } from '@smartdev1990/crona-sdk'
...
import { useRiceContract, useCronaVaultContract } from 'app/hooks/useContract'
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 auto-cols-max">
              <div className="grid grid-cols-1 items-center p-4 rounded-lg bg-dark-800">
                ...
                <h2 className="flex flex-row items-center justify-self-center self-start text-[16px] md:text-[21px] text-[#798090]">
                  veRICE APY&nbsp;
                  <QuestionHelper text="The reward apy of lock RICE." />
                </h2>
              </div>
              <div className="grid grid-cols-1 items-center p-4 rounded-lg bg-dark-800">
              ...
              <div className="grid grid-cols-1 items-center p-4 rounded-lg bg-dark-800">
                ...
                <h2 className="flex items-center place-content-center self-start text-center text-[16px] md:text-[21px] text-[#798090]">
                  ...
                  <span className="mt-[6px]">
                    <QuestionHelper text="Average RICE lock time in veRICE." />
                  </span>
                </h2>
              </div>
              <div className="grid grid-cols-1 items-center p-4 rounded-lg bg-dark-800 px-8">
                <div className="flex flex-row items-center text-[16px] md:text-[21px] text-[#798090]">
                  {i18n._(t`Auto xRice Bounty`)}&nbsp;
                  <span className="mt-[6px]">
                    <QuestionHelper text="This bounty is given as a reward for providing a service to other users. Whenever you successfully claim the bounty, you’re also helping out by activating the Auto RICE Pool’s compounding function for everyone.Auto-Compound Bounty: 0.25% of all Auto RICE pool users pending yield" />
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-[14px] text-light-blue">
                      {'~$'}
                      {formatNumber(
                        Number(Number(harvestRewards?.toFixed(18)) * Number(ricePrice.toFixed(3))).toFixed(3)
                      )}
                    </div>
                  </div>
                  <div className="flex">
            ...
            <div className="gap-4 md:flex">
              ...
              <div className="rounded-lg md:w-1/2 bg-dark-900">
                <div className="py-6 md:py-8 px-8 rounded-t-lg bg-dark-800">
                  <h1 className="text-xl md:text-2xl font-bold">RICE Boost Lock</h1>
                </div>
                <div className="p-6">
                  <div className="flex items-center justify-between w-full">
                    <p className="text-sm md:text-lg text-high-emphesis">{i18n._(t`Your RICE Balance`)}</p>
                    <div className="text-sm font-medium text-high-emphesis md:text-lg md:font-normal">
                      {balance?.toSignificant(12)} RICE
                    </div>
                  </div>
