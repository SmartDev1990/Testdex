...
import { ChainId, Currency, NATIVE, Percent, WNATIVE, WNATIVE_ADDRESS } from '@smartdev1990/crona-sdk'
                        ...
                        {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                          <RowBetween className="text-sm">
                            {oneCurrencyIsETH ? (
                              ...
                              <Link
                                href={`/remove/${currencyA?.equals(WNATIVE[chainId]) ? 'BRISE' : currencyIdA}/${
                                  currencyB?.equals(WNATIVE[chainId]) ? 'BRISE' : currencyIdB
                                }`}
                              >
