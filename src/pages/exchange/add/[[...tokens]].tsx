...
import { Currency, CurrencyAmount, Percent, WNATIVE, currencyEquals } from '@smartdev1990/crona-sdk'
...
export default function Add() {
  ...
  async function onAdd() {
    ...
    if (currencyA.isNative || currencyB.isNative) {
      const tokenBIsETH = currencyB.isToken
  ...
  const handleCurrencyBSelect = useCallback(
    (currencyB: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        router.push(`/add/${currencyIdA ? currencyIdA : 'BRISE'}/${newCurrencyIdB}`)
      }
    },
