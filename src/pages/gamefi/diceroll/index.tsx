...
import { RICE_ADDRESS, Currency, CurrencyAmount, Token } from '@smartdev1990/crona-sdk'
...
const DiceRoll = () => {
  ...
  //const defaultToken = useMemo(() => RICE_ADDRESS[chainId], [chainId])
  const [selectedToken, setselectedToken] = useState<string>(RICE_ADDRESS[chainId])
  useEffect(() => {
    setselectedToken(RICE_ADDRESS[chainId])
  }, [chainId])
