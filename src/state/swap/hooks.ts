...
const BAD_RECIPIENT_ADDRESSES: { [chainId: string]: { [address: string]: true } } = {
  [ChainId.BRISE]: {
    '0x09FB691A786284e99D122D2B68dE40D253fec299': true, // v2 factory
    '0x9507fF69c722bD69FCf42794c92c1C2D0A0f118d': true, // v2 router 02
  },
}
...
export function queryParametersToSwapState(parsedQs: ParsedQs, chainId: ChainId = ChainId.BRISE): SwapState {
  let inputCurrency = parseCurrencyFromURLParameter(parsedQs.inputCurrency)
  let outputCurrency = parseCurrencyFromURLParameter(parsedQs.outputCurrency)
  // const eth = chainId === ChainId.CELO ? WNATIVE_ADDRESS[chainId] : 'BRISE'
  const eth = 'BRISE'
  const sushi = RICE_ADDRESS[chainId]
