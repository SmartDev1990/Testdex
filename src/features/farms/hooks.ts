...
import { ChainId, CurrencyAmount, JSBI, MASTERCHEF_ADDRESS } from '@smartdev1990/crona-sdk'
...
import { RICE } from '../../config/tokens'
...
export function usePendingCrona(farm) {
  ...
  return amount ? CurrencyAmount.fromRawAmount(RICE[chainId], amount) : undefined
}
...
export const useRiceUsdcPrice = (): BigNumber | undefined => {
