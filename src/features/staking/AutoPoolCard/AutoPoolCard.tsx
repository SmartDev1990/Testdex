import { NATIVE } from '@smartdev1990/crona-sdk'
...
import { getAPY, convertSharesToCrona, useWithdrawalFeeTimer, getRicePrice } from 'features/staking/useStaking'
            ...
            <div className="flex gap-x-2">
              ...
              <div className="flex items-center w-1/2 col-span-2 space-x-4 lg:gap-5 lg:w-4/12 lg:col-span-1">
                ...
                <div className="flex flex-col justify-center">
                  <div className="text-xs font-bold md:text-2xl">Auto RICE</div>
              ...
              <div className="flex flex-col justify-center w-2/12 space-y-1">
                <div className="text-xs md:text-[14px] text-secondary">{i18n._(t`Recent RICE Profit`)}</div>
                <div className="text-xs font-bold md:text-base">
                  {formatNumber(results.current[1]?.toFixed(RICE[chainId]?.decimals))}
                </div>
              </div>
              ...
              <div className="flex-col justify-center hidden space-y-1 lg:w-3/12 lg:block">
                ...
                <div className="text-xs font-bold md:text-base">
                  {formatNumber(results.current[0]?.toFixed(RICE[chainId]?.decimals))} {RICE[chainId]?.symbol}
                </div>
              </div>
