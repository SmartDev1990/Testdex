...
import { ChainId, Currency, Percent, Router, TradeType, Trade as V2Trade } from '@smartdev1990/crona-sdk'
      ...
      callback: async function onSwap(): Promise<string> {
        ...
        return library
          ...
          .sendTransaction({
            ...
            gasPrice: !eip1559 && chainId === ChainId.BRISE ? BigNumber.from('20000000000') : undefined,
