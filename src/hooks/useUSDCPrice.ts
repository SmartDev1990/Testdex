import { ChainId, Currency, CurrencyAmount, Price, Token, USDC } from '@smartdev1990/crona-sdk'
...
const STABLECOIN_AMOUNT_OUT: { [chainId: number]: CurrencyAmount<Token> } = {
  ...
  [ChainId.BRISE]: CurrencyAmount.fromRawAmount(USDC[ChainId.BRISE], 100_000e6),
}
