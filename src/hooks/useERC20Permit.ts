import { Currency, CurrencyAmount, JSBI, Percent, Token, TradeType, Trade as V2Trade } from '@smartdev1990/crona-sdk'
import { RICE, USDC } from '../config/tokens'
...
const PERMITTABLE_TOKENS: {
  ...
  [1]: {
    ...
    [RICE[1].address]: { type: PermitType.AMOUNT, name: 'Rice token' },
  },
}
